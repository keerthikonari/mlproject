...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''  
        this function is mainly responsible for data transformation
        ...
        try:
            ...
            logging.info("Catrgorial columns encoding completed")
            preprocessor=ColumnTransformer(
                [
                    ("num_pipeline",num_pipeline,numerical_columns),
                    ("cat_pipelines",cat_pipeline,categorial_feature)
                ]
            )
            return preprocessor
